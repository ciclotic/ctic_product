...
use CTIC\Product\Product\Infrastructure\Controller\ProductController;
use CTIC\Product\Product\Infrastructure\Form\Type\ProductType;
...
class CreateProductController extends CreateResourceController
{
    /**
    ...
    ): void
    {
        ...
        $formRegistry->addType(new ProductType(Product::class));
    }
        ...
        if(empty($command->metadata))
        {
            $command->metadata = self::getMetadata(
                ...
                array(
                    ...
                    'classes'       => array(
                        'form'      => 'CTIC\Product\Product\Infrastructure\Form\Type\ProductType'
                    ),
                    'grid'          => array(
                        'actionGroups'  => array(
                            'bulk'  => array(
    ...
    public static function setDefaultCommand(ResourceControllerCommand $command): void
    {
        if(empty($command->newResourceFactory))
        {
            $command->newResourceFactory = new CreateProduct();
        }
        if(empty($command->resource))
        {
            $command->resource = Product::class;
        }
        if(empty($command->command))
        {
